const services = {
  'application-security': {
    ...
    strategic: [
      ...
      },
      {
        ...
        path: '/application-security/secure-sdlc-program-review',
      },
    ],
    tactical: [
      { title: 'Application Security Assessments', description: 'Understand your attack surface through testing', path: '/application-security/application-security-assessment' },
      {
    ...
    managed: [
      {
        ...
        path: '/application-security/application-security-as-a-service',
      },
    ],
    training: [
      {
        ...
        path: '/application-security/application-threat-modeling',
      },
      {
        title: 'Secure Development Training',
        description: 'Learn how to design & code secure web solutions',
        path: '/application-security/secure-development-training',
      },
      {
      ...
      },
      {
        ...
        path: '/application-security/fundamentals-of-reconnaissance-and-attack-surface-analysis',
      },
    ],
    outcomesSection: {
    ...
    splits: [
      {
        ...
        splitCards: [
          ...
          },
          {
            ...
            link: { text: 'Learn More', href: '/application-security/ai-augmented-application-security' },
          },
        ],
      },
      {
  ...
  'ai-security': {
    ...
    tactical: [
      {
        title: 'AI-augmented Application Security Services',
        description: 'Enhance application security assessments by incorporating artificial intelligence (AI) with expert oversight',
        path: '/application-security/ai-augmented-application-security',
      },
    ],
    managed: [],
  ...
  'cloud-security': {
    ...
    strategic: [
      { title: 'AWS Cloud Security Services', description: 'Secure your Amazon Web Services cloud environment end-to-end', path: '/cloud-security/aws-cloud-security-assessment-services' },
      { title: 'Google Cloud Security Services', description: 'Protect workloads and data across Google Cloud Platform', path: '/cloud-security/google-cloud-security' },
      { title: 'SaaS Security Services', description: 'Safeguard your SaaS application ecosystem', path: '/cloud-security/saas-security' },
      { title: 'Microsoft Security Services', description: 'Maximize security across Microsoft 365 and Azure', path: '/cloud-security/microsoft-security-services' },
      { title: 'Multi-Cloud Security', description: 'Unify security controls across multiple cloud providers', path: '/cloud-security/multi-cloud-security' },
    ],
    tactical: [
      { title: 'Cloud Security Assessments', description: 'Evaluate cloud configurations and identify security gaps', path: '/cloud-security/cloud-security-assessments' },
      { title: 'Cloud Security Strategy Services', description: 'Develop a comprehensive cloud security roadmap', path: '/cloud-security/cloud-security-strategy-architecture-services' },
      { title: 'Cloud Governance', description: 'Establish policies and controls for cloud resource management', path: '/cloud-security/cloud-governance-solutions' },
      { title: 'Cloud Security Engineering', description: 'Design and implement secure cloud architectures', path: '/cloud-security/cloud-security-engineering-services' },
      { title: 'CNAPP Services', description: 'Cloud-native application protection platform services', path: '/cloud-security/cnapp-services' },
      { title: 'Container Security', description: 'Secure containerized workloads and orchestration platforms', path: '/cloud-security/container-security' },
      { title: 'Digital Transformation', description: 'Enable secure digital transformation initiatives', path: '/cloud-security/digital-transformation' },
      { title: 'Zero Trust Workshops', description: 'Implement zero trust principles in your cloud environment', path: '/cloud-security/zero-trust-workshops' },
    ],
    managed: [],
    training: [],
  ...
  'google-cloud-security': {
    ...
    icon: 'bi-cloud',
    tagline: 'Ensure a Strong Security Posture for Your Google Cloud Environment',
    heroLabel: 'GOOGLE CLOUD SECURITY',
    heroHighlight: 'Security Posture',
    ...
    stats: [
      ...
      { number: '50%+', label: 'of workforce are tenured certified engineers and architects' },
      { number: '3', label: 'core service pillars: health checks, engineering and workspace' },
    ],
    heroSplit: {
      label: 'GOOGLE CLOUD SECURITY SERVICES: OVERVIEW',
      title: 'Establish a Robust, Adaptable GCP Security Program',
      titleHighlight: 'Establish',
      subtitle: 'From strategy and health checks to delivering infrastructure as code, our Google-certified cloud security experts can help you implement a strong GCP security program. Services include:',
      cards: [
        { title: 'Google Cloud Health Check' },
        { title: 'Cloud Security Engineering Expertise' },
        { title: 'Google Workspace Security Health' },
      ],
    },
    outcomesVariant: 'indigo-light',
    splits: [
      {
        ...
        paragraphs: [
          'With our GuidePoint Cloud Security Framework (GPCSF), we analyze the people, process and technology that support your Google Cloud security program and deliver a comprehensive report and roadmap.',
      ...
      },
      {
        ...
        paragraphs: [
          'When you need a "hands-on keyboard" to build the security programs inside of Google Cloud, our team of certified Google Cloud engineers and architects will help you deliver secure configurations, policies and infrastructure as code.',
      ...
      },
      {
        ...
        paragraphs: [
          'With our Google Workspace Security Health Check, we thoroughly assess your environment\'s people, processes and technology using the GuidePoint Cloud Security Framework (GPCSF) and the GuidePoint SaaS Security Framework (GPSSF).',
    ...
    certGroups: [
      ...
      },
      {
        ...
        certs: [
          ...
          { name: 'Azure Solutions Architect', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2022/06/Microsoft-365-cert-Azure-solutions-1.png' },
        ],
      },
    ],
    outcomesSection: {
      ...
      titleHighlight: 'Google Cloud-Certified Expertise',
      subtitle: 'Our Google Cloud Security services are designed to help you implement a robust GCP infrastructure and security program with expert guidance covering strategy, health checks and infrastructure as code.',
    },
    outcomes: [
      { title: 'Assess Your Google Cloud Environment', description: 'Evaluate your environment\'s people, process and technology and gain a comprehensive report to improve your security posture.' },
      { title: 'Benefit from Hands-on Expertise', description: 'Leverage our certified Google Cloud engineers to implement secure configurations and infrastructure as code.' },
    ],
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
      author: 'Mark Gilman',
  ...
  'aws-cloud-security-assessment-services': {
    ...
    icon: 'bi-cloud',
    tagline: 'Evolve the Maturity of Your AWS Security Program',
    heroLabel: 'AWS CLOUD SECURITY ASSESSMENT SERVICES',
    heroHighlight: 'Evolve the Maturity',
    heroCta: 'Safeguard Your Cloud',
    ...
    heroSplit: {
      ...
      image: 'https://www.guidepointsecurity.com/wp-content/uploads/2021/11/AWS_Advanced-Consulting_Partner_Cert-e1636417777351.png',
      imageAlt: 'AWS Advanced Consulting Partner',
      imageLeft: true,
      imageStyle: { width: '200px', height: '346px', objectFit: 'contain' },
    },
    splits: [],
    lifecycleStages: {
      label: 'AWS CLOUD SECURITY ASSESSMENT SERVICES APPROACH',
      title: 'We Can Help Build or Enhance Your AWS Cloud Security Program',
      titleHighlight: 'Help',
      subtitle: 'Our cloud security program is broken down into 4 stages: Learn, Assess, Plan & Design and Build.',
      stages: [
        {
          id: 'learn',
          name: 'Learn',
          iconImage: 'https://www.guidepointsecurity.com/wp-content/themes/guidepointsecurity/assets/src/images/icon-aws-lifecycle-1.svg',
          description: 'Keeping up to date with current and emerging technologies is critical for any security organization. As an Advanced Tier AWS Partner, we provide educational sessions to help you understand the evolving cloud landscape.',
          items: [
            { title: 'AWS Immersion Days' },
            { title: 'AWS Security Gameday' },
            { title: '3rd Party Solution Demos' },
          ],
          sectionLabel: 'AWS CLOUD SECURITY PROGRAM: LEARN',
          sectionTitle: 'Get Up to Speed with AWS Cloud Security Solutions',
          sectionTitleHighlight: 'Up to Speed',
          cards: [
            { title: 'AWS Immersion Days', description: 'Workshops and labs designed to help teams learn how to use AWS native solutions to secure and automate their environments.' },
            { title: 'AWS Security Gameday', description: 'A collaborative learning exercise that tests skills in implementing AWS solutions to solve real-world problems in a gamified, risk-free environment.' },
            { title: '3rd Party Solution Demos', description: 'Understand the nuances, benefits and limitations of implementing CSPM, CWPP, CASB, CIEM and other tools.' },
          ],
        },
        {
          id: 'assess',
          name: 'Assess',
          iconImage: 'https://www.guidepointsecurity.com/wp-content/themes/guidepointsecurity/assets/src/images/icon-aws-lifecycle-2.svg',
          description: 'A critical part of securing a cloud environment is having a thorough understanding of the current state. We offer multiple ways to assess your AWS environment:',
          items: [
            { title: 'AWS Well-Architected Review' },
            { title: 'AWS Security Health Check' },
            { title: 'AWS Security Maturity Assessment' },
            { title: 'AWS Architecture Review' },
            { title: 'Cloud-Native Application Architecture Review' },
            { title: 'Cloud Penetration Testing' },
          ],
          sectionLabel: 'AWS CLOUD SECURITY PROGRAM: ASSESS',
          sectionTitle: 'Evaluate Your AWS Architecture, Maturity, Applications and More',
          sectionTitleHighlight: 'Evaluate',
          cards: [
            { title: 'AWS Well-Architected Review', description: 'We will review the state of your workloads and implement AWS Well-Architected best practices to help with security optimization, risk mitigation, cost reductions and improved application performance. Based on five pillars, an AWS Well-Architected Review will help identify risks and recommend best practices.' },
            { title: 'AWS Cloud Security Health Check', description: 'Building on top of the AWS Well-Architected Review, we will evaluate your environment against our cloud security framework, interview staff managing your environment to understand strengths and gaps and review processes used to secure the environment. You gain a robust report and roadmap to remediate any identified issues.' },
            { title: 'AWS Security Maturity Assessment', description: 'Our cloud maturity assessment goes beyond the health check to provide a quantified snapshot of your current state and give you a clear roadmap for improvement and optimization including key strategic areas such as:', checklist: ['Identity & Access Management', 'Networking', 'Incident response', 'Disaster recovery'] },
            { title: 'AWS Architecture Review', description: 'As development teams move very quickly, it helps to review application architectures via an AWS vulnerability assessment. Our team of certified Cloud Security Solution Architects can help you implement and maintain a "security first" AWS architecture by examining existing and new architectures to identify any vulnerabilities.' },
            { title: 'Cloud-Native Architecture Review', description: 'Securing cloud-native applications using serverless or containers requires a thorough understanding of both the AWS environment and the application code.' },
            { title: 'Cloud Penetration Testing', description: 'Our cloud security experts simulate real-world attacks against your AWS environment to identify exploitable vulnerabilities, misconfigurations and weaknesses before adversaries can leverage them.' },
          ],
        },
        {
          id: 'plan-design',
          name: 'Plan & Design',
          iconImage: 'https://www.guidepointsecurity.com/wp-content/themes/guidepointsecurity/assets/src/images/icon-aws-lifecycle-4.svg',
          description: 'Whether you are looking for a full cloud cybersecurity strategy, a prioritized roadmap or specific secure architectures for your organization, we can help you plan and design your ideal AWS environment.',
          items: [
            { title: 'AWS Cloud Security Strategy' },
            { title: 'AWS Cloud Security Roadmap' },
            { title: 'Secure AWS Network Architecture' },
            { title: 'Secure AWS Serverless Architecture' },
          ],
          sectionLabel: 'AWS CLOUD SECURITY PROGRAM: PLAN & DESIGN',
          sectionTitle: 'Architect Your AWS Cloud Security Strategy',
          sectionTitleHighlight: 'Architect',
          cards: [
            { title: 'AWS Cloud Security Strategy', description: "We combine our deep AWS cloud security and application security expertise to help create a customized AWS cloud security strategy that addresses your organization's specific needs. We will identify requirements and implementation strategies for cloud foundations, perimeter, data, visibility and individual cloud services." },
            { title: 'AWS Cloud Security Roadmap', description: 'Our roadmap service will provide you with a prioritized list of key AWS cloud service initiatives – based on your existing environment – that will incrementally strengthen your organization\'s cloud security posture.' },
            { title: 'Secure AWS Network Architecture', description: 'Our team of Cloud Security Architects can help design a network architecture that accounts for the impact on your people, processes and technologies to ensure its effectiveness for your organization. Ranging from fully-centralized to completely distributed, our experts are able to architect cloud-native, hybrid and multi-cloud networking implementations.' },
            { title: 'Secure AWS Serverless Architecture', description: "Serverless architectures are redefining how security is being incorporated into organizations' applications. Our team of experts can help you define serverless architecture patterns so that your organization can take advantage of the flexibility and scalability of serverless without compromising security." },
          ],
        },
        {
          id: 'build',
          name: 'Build',
          iconImage: 'https://www.guidepointsecurity.com/wp-content/themes/guidepointsecurity/assets/src/images/icon-aws-lifecycle-3.svg',
          description: 'Our team of AWS and DevSecOps experts can ensure that security controls are built into your AWS environment.',
          items: [
            { title: 'Secure Infrastructure CI/CD Pipeline' },
          ...
          sectionLabel: 'AWS CLOUD SECURITY PROGRAM: BUILD',
          sectionTitle: 'Build and Secure Your AWS Infrastructure',
          sectionTitleHighlight: 'Build and Secure',
          cards: [
            { title: 'Secure Infrastructure CI/CD Pipeline', description: 'Our team of skilled DevSecOps engineers and architects can help build infrastructure CI/CD pipelines with a security-first mindset.' },
            { title: 'Infrastructure-as-Code', description: 'We can help build out your infrastructure using Terraform or CloudFormation and provide guidance and training on best practices.' },
            { title: 'Policy-as-Code', description: "We can work with your security team to codify existing policies so that they can be integrated into your organization's software development life cycle." },
            { title: 'Detective Controls', description: 'Our team can create custom AWS Config rules to detect the latest AWS security service or fine-tuning CSPM solutions to detect misconfigurations that impact your organization.' },
            { title: 'Preventative Controls', description: "We've developed a library of AWS service control policies and infrastructure-as-code checks that can help you implement appropriate guardrails for your organization." },
            { title: 'Auto-Remediation', description: "We can help you address sensitive resource misconfigurations by implementing event-driven, auto-remediation solutions that will automate your security team's response." },
          ],
        },
      ],
    },
  ...
  'saas-security': {
    ...
    splits: [
      {
        ...
        titleHighlight: 'Complete SaaS Security',
        paragraphs: [
      ...
      },
      {
        ...
        imageLeft: true,
        splitCardsHeader: {
          title: 'A SaaS security health check with GuidePoint means:',
        },
        splitCards: [
          { biIcon: 'bi-people', title: 'A Collaborative Approach', description: 'We work with stakeholders to understand the environment, define challenges and establish goals that will make an impact.' },
          { biIcon: 'bi-search', title: 'Deep Discovery', description: 'We discover overlooked vulnerabilities and analyze configurations to empower the organization to strengthen their SaaS security posture.' },
          { biIcon: 'bi-lightbulb', title: 'Tailored Recommendations', description: 'Stakeholders receive strategic guidance and a clear roadmap, along with recommendations aligned with industry frameworks and best practices.' },
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Visibility without action delivers no security value. Our risk monitoring advisory service goes beyond just identifying vulnerabilities. We empower your team to operationalize your SaaS Security Posture Management (SSPM) tool and drive meaningful, ongoing risk reduction across your cloud application portfolio.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2026/02/Continuous-Saas-Security-Operations.png',
        imageStyle: { width: '100%', maxWidth: '530px', height: 'auto', margin: '0 auto', display: 'block' },
        imageLeft: true,
        imageContain: true,
        inlineItems: [
          { title: 'Structured Risk Reviews', description: 'Stay on top of security risks with regular risk reviews that provide insight into concerns and prioritized, actionable guidance to improve security posture.' },
          { title: 'Workflow Optimization', description: 'Streamline security operations with custom ticketing integrations, automated escalation processes and optimized workflows.' },
          { title: 'Executive Reporting', description: 'Demonstrate the value of SaaS security to stakeholders with metrics and dashboards that demonstrate the impact of security improvements across the organization.' },
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'With clarity, strategic guidance and execution, GuidePoint takes organizations from reactive to proactive security management across even the most complex SaaS environments.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
        imageLeft: false,
        showAll: true,
        splitCardsHeader: {
          title: 'SaaS security program development includes:',
        },
        splitCards: [
          { biIcon: 'bi-search', title: 'Baseline and Discovery', description: 'We start with data by uncovering the organization\'s full SaaS footprint, understanding access and usage and surfacing real, actionable risks.' },
          { biIcon: 'bi-compass', title: 'Strategic Design', description: 'With full clarity, we tailor a strategy that defines policies, controls and governance models aligned with regulatory demands, best practices and business objectives.' },
          { biIcon: 'bi-gear', title: 'Implementation', description: 'Starting with repeatable procedures for onboarding applications and users, we enable configuration monitoring, posture management and access governance.' },
        ],
      },
    ],
    hideOutcomes: true,
    engagementSection: {
      label: 'TAILORED SAAS SECURITY ENGAGEMENTS',
      title: 'Choose the Best Engagement Model for Your Organization',
      titleHighlight: 'Engagement Model',
      subtitle: 'GuidePoint tailors each engagement based on the organization\'s needs, goals and scope. Choose the engagement model that works now and expand as needed to continually improve SaaS security.',
      cards: [
        { title: 'Point-in-time Assessments', description: 'Review a single application for compliance requirements and risk analysis.' },
        { title: 'Multi-application Engagements', description: 'Identify common risks across the organization\'s entire SaaS portfolio and prioritize critical platforms for impactful improvements.' },
        { title: 'Ongoing Advisory', description: 'Gain continuous guidance with regular risk reviews and tap into retainer-based support to improve SaaS security posture over time.' },
        { title: 'Full Program Buildouts', description: 'Develop an end-to-end SaaS security solution with governance processes and integration into existing security functions.' },
      ],
    },
    certGroups: [
      {
    ...
    outcomesSection: {
      ...
      title: 'Achieve Measurable SaaS Security Results',
      titleHighlight: 'Measurable SaaS Security Results',
    },
    outcomes: [
      { title: 'Reduce Risk at Scale', description: 'Gain comprehensive visibility across your SaaS ecosystem and eliminate blind spots with expert-led, strategic improvements.' },
      { title: 'Operationalize SaaS Security', description: 'Centralize SaaS security operations and automate application onboarding, configuration monitoring and access governance.' },
      { title: 'Maintain Continuous Compliance', description: 'Achieve systematic, automated compliance with CIS, NIST, CSA CCM and SSCF frameworks across your entire SaaS portfolio.' },
    ],
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
      author: 'Mark Gilman',
  ...
  'multi-cloud-security': {
    ...
    heroSplit: {
      label: 'MULTI-CLOUD SECURITY SERVICES: OVERVIEW',
      title: 'Establish a Robust, Adaptable Multi-Cloud Security Program',
      titleHighlight: 'Establish',
      subtitle: 'With 93% of organizations utilizing more than one cloud service provider, it\'s critical to create a comprehensive cloud security strategy that effectively spans all platforms. Our services include:',
      cards: [
        { title: 'Cloud Security Strategy & Architecture' },
        { title: 'Multi-Cloud Health Check' },
        { title: 'Multi-Cloud Security Maturity Assessments' },
      ],
    },
    splits: [
      {
    ...
    engagementSection: {
      ...
      title: 'Strengthen Your Multi-Cloud Security Strategy',
      titleHighlight: 'Strengthen',
      subtitle: 'Our Multi-Cloud Security solutions are designed to help you develop a robust security strategy that enhances resiliency and security across all platforms, backed by our team\'s extensive experience with leading cloud providers.',
      cards: [
        { title: 'Mature Your Security', description: 'Gain expert guidance on Infrastructure as Code, Policy as Code, CI/CD frameworks and secure multi-cloud security architectures as well as recommendations to address identified gaps.' },
        { title: 'Gain a 360 Degree View of Your Environment', description: 'Get a full picture of your multi-cloud environment with a maturity assessment that covers your people, processes and technologies.' },
      ],
    },
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
  ...
  'cloud-security-assessments': {
    ...
    heroSplit: {
      label: 'CLOUD SECURITY ASSESSMENT OVERVIEW',
      title: 'Evaluate Your Cloud Security Environment',
      titleHighlight: 'Evaluate',
      subtitle: 'The cloud provides many business and operational advantages, but you must understand your cloud readiness and maturity in order to ensure a "security first" approach. Our cloud security assessment services include:',
      cards: [
    ...
    splits: [
      {
        ...
        paragraphs: [
          'Our Cloud Readiness Assessment gives your organization actionable steps to follow in order to successfully adopt a cloud-based environment. We\'ll work with you to better understand the current hurdles that must be overcome to successfully migrate to the cloud, the items that your technology stack currently contains and the dependencies that need to be considered before and during a cloud migration.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
        imageLeft: false,
      },
      ...
      },
      {
        ...
        paragraphs: [
          'Our health check service provides a look at your cloud environment from a people, process and technology perspective. We provide a comprehensive report and roadmap to remediating any issues discovered with a comprehensive cloud vulnerability assessment.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
        imageLeft: false,
        checklist: [
          'Technology: We examine your cloud environment against our cloud security framework, which combines industry standards like NIST, CCM and CSP controls along with our own controls.',
          'People: We interview individuals who manage your cloud security assessments program to understand the strengths and weaknesses of your program.',
      ...
      },
      {
        ...
        title: 'Identify Gaps in Your Cloud Infrastructure',
        titleHighlight: 'Identify',
        paragraphs: [
          'Our Cloud Infrastructure Security Assessment provides your organization with a clear understanding of your cloud security posture.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_left.png',
        imageLeft: true,
        splitCards: [
          { title: 'Develop a Gap Analysis', description: 'Make it easy to understand the biggest challenges to overcome BEFORE your cloud migration.' },
          { title: 'Maintain Compliance', description: 'Ensure compliance with relevant industry regulations as you begin working in a cloud environment.' },
          { title: 'Gain Trusted Recommendations', description: 'Leverage reliable, custom-fit solutions to remediate vulnerabilities in your cloud environment.' },
        ],
      },
      {
        label: 'CLOUD SECURITY AUDIT',
        title: 'Ensure Industry Compliance',
        titleHighlight: 'Compliance',
        paragraphs: [
          'It is essential that your organization ensures industry compliance if it\'s handling sensitive data — particularly relevant to organizations routinely handling healthcare and financial-related information. By conducting a cloud security audit, we can help you identify any existing gaps in your security compliance and provide recommendations to remediate those gaps.',
          'We only conduct our security audits after gaining a clear understanding of the cloud security policies that have been put in place by your cloud service provider and we will help you prepare for any upcoming security compliances that your organization intends to acquire.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
        imageLeft: false,
        showAll: true,
    ...
    hideOutcomes: true,
    engagementSection: {
      label: 'CLOUD SECURITY ASSESSMENT OUTCOMES',
      title: 'Know Where You Are in Your Cloud Journey',
      titleHighlight: 'Cloud Journey',
      subtitle: 'Our Cloud Security Assessments are designed to help you understand your organization\'s cloud readiness and the maturity level of your organizational cloud posture.',
      cards: [
        { title: 'Adopt a Secure Cloud Environment', description: 'Better understand the obstacles to ensuring a secure migration to the cloud.' },
        { title: 'Mature Your Cloud Security Capabilities', description: 'Gain a quantifiable assessment of your existing cloud estate with clear steps to improve and optimize.' },
        { title: 'Remediate Cloud Vulnerabilities', description: 'Analyze your people, process and technology to identify and remediate cloud-related risks.' },
      ],
    },
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
  ...
  'cloud-security-strategy-architecture-services': {
    ...
    heroSplit: {
      label: 'CLOUD SECURITY STRATEGY OVERVIEW',
      title: 'Ensure the Right Cloud Security Controls are in Place',
      titleHighlight: 'Controls',
      paragraphs: [
        'With the continuous evolution of cloud computing and the constant rate of change its services have provided, it can be difficult to keep your cloud security strategy controls and processes up to speed.',
        'We can help you navigate cloud computing\'s constant state of flux by arming you with the right framework for cloud security controls as well as the best-fit cloud security tools to continuously monitor and manage risks and threats. Our security-first approach to your cloud environment is designed to:',
      ],
      cards: [
        { title: 'Comply with Emerging Standards and Compliance Programs' },
        { title: 'Minimize the Complexity of Your Cloud Environment' },
        { title: 'Reduce Security Risks Within Your Cloud Environment' },
      ],
    },
    splits: [
      {
        ...
        titleHighlight: '\u201cRight Framework\u201d',
        paragraphs: [
          'We\'ve developed a unique cloud security controls framework that assists you in creating a secure cloud environment and outlines key objectives. Our cloud security controls framework reviews over 150 risk and security controls based on the Cloud Security Alliance (CSA), CIS and our own operational experiences.',
          'With the guidance of our cloud security company controls, your organization will be better able to track your services in the cloud and ensure they are all properly and securely configured. Additionally, our automated cloud security controls will account for your security-first cloud environment\'s dynamic nature, which is particularly important for easing the burden on your cybersecurity teams.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
      },
      {
        ...
        paragraphs: [
          ...
          'In light of the fact that a growing number of IT systems are becoming externalized, it\'s imperative that your organization selects a cloud provider that is conducive to your long-term success. We help you consider areas including cloud providers\' certifications and standards, policies on data governance and security, reputations for reliability, key technologies used and partnerships and service dependencies.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_left.png',
      },
    ],
    certGroups: [
      {
        ...
        certs: [
          ...
          { name: 'CCSP', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/09/gps-cert-ccsp.png' },
          { name: 'GIAC GSE', image: '/images/certs/gse.png' },
        ],
      },
      {
        category: 'Cloud Platforms',
        certs: [
          ...
          { name: 'Azure Solutions Architect', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2022/06/Microsoft-365-cert-Azure-solutions-1.png' },
          { name: 'Google Cloud Architect', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/09/gps-cert-google-cloud-architect.png' },
          { name: 'AWS Advanced Consulting Partner', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/07/AWS-CP-Security.png' },
        ],
      },
    ],
    outcomesSection: {
      label: 'CLOUD SECURITY STRATEGY SERVICES OUTCOMES',
      title: 'Gain the Benefits of Having a Sound Cloud Security Strategy',
      titleHighlight: 'Gain the Benefits',
      subtitle: 'Our Cloud Security Strategy service will help you ensure a \u201csecurity first\u201d approach to your cloud journey.',
    },
    outcomes: [
      { title: 'Develop a Robust Cloud Security Plan', description: 'Protect your cloud environment from cyber threats, prevent data breaches and ensure compliance with cloud security regulations.' },
      { title: 'Gain Company Support and Alignment', description: 'A solid cloud security will enable you to meet your objectives and adhere to security policies, procedures and standards.' },
      { title: 'Ensure Regular Audits and Reviews', description: 'We help you regularly audit and review your cloud security strategy to determine whether additional objectives should be considered.' },
    ],
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
      author: 'Mark Gilman',
  ...
  'cloud-governance-solutions': {
    ...
    icon: 'bi-cloud',
    tagline: 'Align Your Cloud Security Goals',
    ...
    heroSplit: {
      label: 'CLOUD GOVERNANCE OVERVIEW',
      title: 'Implement a Modern Approach to Cloud Security Governance',
      titleHighlight: 'Implement',
      paragraphs: [
        'The cloud introduces efficiency and enables innovation to facilitate modern and competitive architectures. As cloud environments are in constant flux, they constantly evolve in tandem with new enhancements and your organization must evaluate new capabilities and features against its security, budgetary and regulatory requirements. This oftentimes can lead to hasty decisions that result in poor integration, configurations without proper access control, lack of alignment between cloud teams and your company\'s security goals and duplication of effort between different parts of the organization.',
        'Our cloud governance solution gives you the ability to make informed decisions that will allow your organization to safely move at the speed of the cloud.',
      ],
      cards: [
        { title: 'Oversee Control and Direction of Cloud Services' },
        { title: 'Manage Risk While Enabling the Benefits of Cloud Computing' },
        { title: 'Become an Organization of \u201cKnow\u201d instead of \u201cNo\u201d' },
      ],
    },
    splits: [
      {
        ...
        paragraphs: [
          'Since the inception of cloud computing, administrators, engineers and builders can extend the data center too easily and sometimes the new environments appear to be a different organization within the same organization.',
          'Our team of experts leverage our five-phase methodology to ensure your organization has a properly implemented Cloud Governance solution. For many organizations operating in the cloud, proper identification and implementation of controls really do matter. Our unique methodology ensures your organization meets the requirements that are critical for managing operations and security risk by bringing together your GRC, security and cloud teams.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
      },
      {
        ...
        imageLeft: true,
        paragraphs: [
          'Our approach to cloud security will build an understanding of your business goals for cloud adoption, guide you in creating organizational policies and standards for those goals and ensure your cloud systems meet those requirements as well as security and compliance best practices. Our team of cloud security experts will communicate with critical stakeholders and do a comprehensive risk assessment to provide a roadmap for your business.',
    ...
    outcomesSection: {
      ...
      title: 'Navigate Dynamic Cloud Environments',
      titleHighlight: 'Navigate',
      subtitle: 'Our service leverages cloud governance solutions to help better ensure compliance with governance rules, take advantage of cloud-based disaster recovery solutions that enhance your application security, optimize operational efficiency, mitigate cybersecurity risks and ultimately enable seamless scalability.',
    },
    outcomes: [
      { title: 'Manage Costs and Control Workloads', description: 'Gain visibility to control workloads against regulatory baselines and security standards.' },
      { title: 'Ensure Security Controls are Current', description: 'Keep your security controls updated as regulations and threats continue to evolve.' },
      { title: 'Minimize Risk and Optimize Resources', description: 'Institute processes that focus on risk mitigation and resource allocation optimization.' },
    ],
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
      author: 'Mark Gilman',
  ...
  'cloud-security-engineering-services': {
    ...
    icon: 'bi-cloud',
    tagline: 'Engineer Your Cloud Journey to Ensure Security',
    ...
    heroSplit: {
      label: 'CLOUD SECURITY ENGINEERING OVERVIEW',
      title: 'Our Team of Cloud Security Engineers are Ready to Execute on Your Vision',
      titleHighlight: 'Ready to Execute',
      paragraphs: [
        'The increasing prevalence of cloud-based services and the potential risks that are associated with cloud computing make it more important than ever for organizations to invest in cloud engineering and security. It\'s practically impossible for your organization to migrate to a cloud platform without both understanding the implicit risks involved and the ways to protect your teams and customers from those risks.',
        'Our team of cloud security engineering experts can help you navigate the journey to secure modernization. We\'ve been there before and can guide your team to a strong security posture. Our cloud security engineers will help you:',
      ],
      cards: [
        { title: 'Comply with Emerging Standards and Compliance Programs' },
        { title: 'Meet Internal and External Policies and Requirements' },
        { title: 'Interface with External Auditors and Key Stakeholders' },
      ],
    },
    splits: [
      {
        ...
        paragraphs: [
          ...
          'Our team of cloud-native specialists and cloud-certified architects rely on a deep understanding of cloud-native services as well as a security-first approach to:',
        ],
        checklist: [
          'Accelerate your migration to a cloud computing environment',
          'Help you adopt native cloud services and implement modern practices',
        ],
        extra: [
          'We are able to thoroughly analyze the cloud architecture your organization uses to develop a robust cloud security roadmap and strategy while ensuring productivity remains uninterrupted and potential security risks are mitigated and addressed.',
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
      },
      {
        ...
        imageLeft: true,
        paragraphs: [
          'The speed at which organizations in multiple industries are migrating to cloud computing environments has not gone unnoticed by regulatory agencies. These agencies are tasked with ensuring that organizations maintain secure operations in the cloud as well as satisfactory levels of data security and protection. Our cloud engineering services can help your organization improve its compliance with industry regulations and standards, which will benefit you by:',
        ],
        checklist: [
    ...
    outcomesSection: {
      label: 'CLOUD SECURITY ENGINEERING OUTCOMES',
      title: 'Execute Your Cloud Security Objectives',
      titleHighlight: 'Execute',
      subtitle: 'Our Cloud Security Engineering team is ready to help you build out or enhance your cloud security requirements and roadmap.',
    },
    outcomes: [
      { title: 'Deliver on a Robust Cloud Security Strategy', description: 'Ensure productivity remains uninterrupted and potential cloud security risks are mitigated and addressed.' },
      { title: 'Improve Compliance with Regulations and Standards', description: 'Ensure visibility and adherence to compliance requirements and avoid disruptions during an audit.' },
      { title: 'Accelerate Your Cloud Migration in a Secure Manner', description: 'We can scale our cloud security engineering resources to help you adopt native cloud services and implement modern practices.' },
    ],
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
      author: 'Mark Gilman',
  ...
  'container-security': {
    ...
    icon: 'bi-cloud',
    tagline: 'Ensure Strong Security Controls for Your Cloud Containers',
    heroLabel: 'CONTAINER SECURITY SERVICES',
    heroHighlight: 'Security Controls',
    heroCta: 'Safeguard Your Cloud',
    heroImage: '/images/heroes/aws-cloud-security-assessment-services.jpg',
    description:
    ...
    heroSplit: {
      ...
      paragraphs: [
        ...
        'Our team has deep expertise and knowledge of container technologies. We can help you:',
      ],
      cards: [
        { title: 'Understand and Implement Container Security Best Practices', description: 'Secure and stabilize your container ecosystem.' },
        { title: 'Ensure Strong Container Security Controls', description: 'Secure every aspect of your development and delivery pipeline.' },
      ],
    },
    splits: [
      {
        ...
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
        splitCards: [
          { title: 'CI/CD Pipeline Development', description: 'We can help you build or enhance your secure DevOps model, which ensures your container strategy is more resilient and compliant.' },
          { title: 'Container Environment Automation', description: 'Our team will help you create a secure, automated environment that ensures stability and compliance in your container program.' },
          { title: 'Container Portability', description: 'When it comes to moving containers to production, we can help implement container portability and ensure strong security between environments.' },
          { title: 'Resource Efficiency and Density', description: 'We can help optimize your containers to ensure you have enough resources available to handle any workload spikes and to downsize when needed.' },
          { title: 'Container Orchestration', description: 'Understand and implement a comprehensive solution to manage the herd of computing resources and ensure resilience.' },
          { title: 'Public Cloud, On-Prem Support', description: 'Our team will help you determine what available infrastructure to use and create a strong container security solution to meet your needs.' },
          { title: 'Multi-Cloud Strategy', description: 'Containers can live in any cloud environment and as such our experts will help you implement a secure multi-cloud container strategy.' },
          { title: 'Microservice Architecture', description: 'Understand this foundation for modern application architecture and how to properly secure and implement microservice strategies.' },
          { title: 'Traditional Application Migration to Microservices', description: 'Break down your application into a roadmap that includes security measures to ensure the integrity and end user experience is maintained.' },
        ],
      },
    ],
    certGroups: [
    ...
    outcomesSection: {
      ...
      title: 'Gain the Benefits of Containers without the Risk',
      titleHighlight: 'Gain',
      subtitle: 'Our Container Security services help you take advantage of modern application architectures in the cloud.',
    },
    outcomes: [
      { title: 'Ensure Strong Security Controls', description: 'Secure every aspect of your development and delivery pipeline.' },
      { title: 'Ensure Best-Fit Security Tools and Integration', description: 'We can help you evaluate and select the best-fit security technologies to address containers as part of your security and compliance needs.' },
      { title: 'Improve Developer Productivity', description: 'From training to actual implementation, we can help you ensure a strong container security routine.' },
    ],
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
      author: 'Mark Gilman',
  ...
  'digital-transformation': {
    ...
    icon: 'bi-cloud',
    tagline: 'Ensure Security is Included in Your Digital Transformation Journey',
    heroLabel: 'DIGITAL TRANSFORMATION SERVICES',
    heroHighlight: 'Ensure',
    heroCta: 'Safeguard Your Cloud',
    heroImage: '/images/heroes/digital-transformation.jpg',
    description:
      'Ensure security is included in your digital transformation journey with the right strategy, expertise and toolsets.',
    heroSplit: {
      ...
      subLabel: 'DIGITAL TRANSFORMATION SERVICES',
      subTitle: 'We Can Help With Your Digital Transformation',
      subTitleHighlight: 'Help',
      subSubtitle: 'Our digital transformation services include:',
      cards: [
        { title: 'Cloud Security Assessments', description: 'Receive a scored report evaluating the maturity level of your organizational posture for the cloud.' },
        { title: 'Cloud Security Strategy and Architecture', description: 'Leverage our unique controls framework to help determine the right infrastructure, services and cloud providers.' },
        { title: 'Cloud DevOps', description: 'Implement a full DevOps environment in the cloud with a security-first mindset baked into the process.' },
      ],
    },
    splits: [
      {
        ...
        bgClass: 'indigo',
        cards: [
          { title: 'AWS Security', description: 'Our AWS security experts help you design and implement a secure AWS environment that meets your compliance and security requirements.' },
          { title: 'Azure Security', description: 'Leverage our Azure security expertise to build and maintain a secure Microsoft Azure environment aligned to best practices.' },
          { title: 'Google Cloud Security', description: 'Our Google Cloud security practitioners can help you architect and secure your Google Cloud environment end to end.' },
          { title: 'Multi-Cloud Security', description: 'Ensure consistent security controls and governance across multiple cloud environments with our multi-cloud security services.' },
          { title: 'Oracle Cloud Security', description: 'Protect your Oracle Cloud infrastructure with specialized security assessment, advisory and implementation services.' },
          { title: 'SaaS Security', description: 'Secure your SaaS applications and ensure proper configuration, access management and data protection across your portfolio.' },
        ],
      },
    ],
    certGroups: [
    ...
    outcomesSection: {
      ...
      title: 'Secure Your Digital Transformation Initiatives',
      titleHighlight: 'Secure',
      subtitle: 'We are an Advanced AWS Consulting Partner and our cloud security services are designed to help you benefit from the cloud and further mature your digital transformation.',
    },
    outcomes: [
      { title: 'Benefit from the Cloud Without Risk', description: 'Leverage cloud agility and scalability while ensuring security controls are built in from day one.' },
      { title: 'Bake Security into Your DevOps Model', description: 'Embed security practices and tooling into your CI/CD pipelines so security never slows down delivery.' },
      { title: 'Ensure Best-Fit Cloud Security Tools', description: 'We can help you evaluate and select the best-fit security technologies to address your cloud transformation needs.' },
    ],
    testimonial: {
      quote: 'GuidePoint Security is basically family. They\'re always there when I need them. At the end of the day GuidePoint is always there to help and that\'s how they add value.',
      author: 'Mark Gilman',
  ...
  'zero-trust-workshops': {
    ...
    tagline: 'Establish Your Roadmap for Zero Trust Adoption',
    heroLabel: 'ZERO TRUST WORKSHOPS AND CONSULTING SERVICES',
    heroHighlight: 'Establish',
    heroCta: 'Safeguard Your Cloud',
    heroImage: '/images/heroes/google-cloud-security.jpg',
    description:
    ...
    heroSplit: {
      label: 'ZERO TRUST WORKSHOPS OVERVIEW',
      title: 'Incrementally Build the Right Zero Trust Strategy',
      titleHighlight: 'Build',
      subtitle: 'A Zero Trust security model is an end-to-end strategy around least-privilege that involves integrating identity, infrastructure, monitoring, analytics and automation. While it is all-encompassing, it does not require an entire re-architecture to achieve zero trust security.',
      paragraphs: [
        'Our Zero Trust Workshops are designed to facilitate your journey through iterative, manageable steps to:',
      ],
      cards: [
        { title: 'Understand Your Maturity Level & Enhance Your Zero Trust Transformation' },
        { title: 'Drive the Adoption of Critical Capabilities in Interactive Steps' },
        { title: 'Optimize Existing Controls to Align With Your Risk Reduction Goals' },
      ],
    },
    lifecycleStages: {
      ...
      stages: [
        {
          ...
          name: 'Discover',
          biIcon: 'bi-lightbulb',
          description: 'Identify key stakeholders in your organization, review your Zero Trust business drivers, capture the relevant use cases and requirements and review your existing security architecture.',
          items: [
            { title: 'Identify key stakeholders and business drivers' },
            { title: 'Capture Zero Trust use cases and requirements' },
            { title: 'Review existing security architecture and controls' },
          ],
        },
        {
          id: 'assess',
          name: 'Assess',
          biIcon: 'bi-clipboard-data',
          description: 'Evaluate your current security posture against Zero Trust principles and identify gaps across identity, access, network and data domains.',
          items: [
            { title: 'Assess current identity and access controls' },
            { title: 'Map network trust boundaries and data flows' },
            { title: 'Identify gaps against Zero Trust best practices' },
          ],
        },
        {
          id: 'design',
          name: 'Design',
          biIcon: 'bi-pencil-square',
          description: 'Develop a tailored Zero Trust architecture and phased implementation roadmap that addresses your organization\'s unique requirements and risk profile.',
          items: [
            { title: 'Define Zero Trust policies and access controls' },
            { title: 'Select best-fit Zero Trust technologies' },
        ...
        },
        {
          ...
          name: 'Build',
          biIcon: 'bi-tools',
          description: 'Implement Zero Trust controls incrementally across your network, identity, application and data layers with minimal disruption to operations.',
          items: [
            { title: 'Deploy identity and access management controls' },
            { title: 'Implement network micro-segmentation' },
            { title: 'Integrate security monitoring and analytics' },
          ],
        },
        {
          id: 'maintain',
          name: 'Maintain',
          biIcon: 'bi-arrow-repeat',
          description: 'Continuously monitor, refine and optimize your Zero Trust implementation to ensure it adapts to evolving threats and changing business requirements.',
          items: [
            { title: 'Monitor Zero Trust policy effectiveness' },
            { title: 'Refine controls based on threat intelligence' },
            { title: 'Continuously improve and mature your security posture' },
          ],
        },
      ],
    },
    splits: [
      ...
      {
        label: 'ZERO TRUST WORKSHOPS: IDENTITY & ACCESS MANAGEMENT',
        title: 'Prioritize IAM as Network Perimeters Evolve',
        titleHighlight: 'Prioritize',
        paragraphs: [
      ...
      {
        label: 'ZERO TRUST WORKSHOPS: CLOUD MICRO-SEGMENTATION',
        title: 'Prevent Unwanted Lateral Movement Through Workload Separation',
        titleHighlight: 'Prevent',
        paragraphs: [
        ...
        sections: [
          {
            paragraph: 'Our Zero Trust consultants work with you to:',
            items: [
      ...
      {
        label: 'ZERO TRUST WORKSHOPS: MONITORING & VISIBILITY',
        title: 'Validate the Effectiveness of Your Zero Trust Policies and Tools',
        titleHighlight: 'Validate',
        paragraphs: [
    ...
    certGroups: [
      ...
      },
      {
        ...
        certs: [
          { name: 'Zscaler Authorized Partner', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/07/Zscaler_Certification.png' },
          { name: 'Check Point CCSE', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/CCSE_Core_certification_600X600_202302221338322.png' },
          { name: 'Check Point CCSA', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/CCSA_Core_certification_600X600_202302221337171.png' },
          { name: 'Cisco CCNP Security', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/07/CCNP_security_100x120px.png' },
          { name: 'Cisco CCNP', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/07/CCNP_cert_100x120px.png' },
          { name: 'Palo Alto PCNSA', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/07/pan_pcnsa_paloalto_cert_100x120px.png' },
          { name: 'Palo Alto PCNSE', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/07/PCNSE_paloalto_cert_100x120px.png' },
          { name: 'Palo Alto PCCSE', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/07/pan_pccse_paloalto_cert_100x120px.png' },
          { name: 'Fortinet Certified Fundamentals', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/01/cert_fortinet_fund.png' },
          { name: 'Fortinet Certified Associate', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/01/cert_fortinet_associate.png' },
        ],
      },
    ],
    outcomesSection: {
      label: 'ZERO TRUST WORKSHOPS OUTCOMES',
      title: 'Facilitate Zero Trust Adoption',
      titleHighlight: 'Facilitate',
      subtitle: 'Our Zero Trust Workshops are designed to accelerate your organization\'s adoption of a Zero Trust approach and digital transformation through an iterative process that develops and assigns use cases to your environment and maturity.',
    },
    outcomes: [
      { title: 'Enforce Security Policy', description: 'Centrally manage and automate security and access policy enforcement.' },
      { title: 'Enhance Visibility', description: 'Understand application and traffic profiles, design and validate access policies and detect abnormal traffic or policy violations.' },
      { title: 'Secure Workloads', description: 'Ensure the security of workloads and assets in both cloud and on-premise environments.' },
      { title: 'Improve Business Agility', description: 'Provide a superior end-user experience through seamless automation.' },
    ],
    testimonial: {
  ...
  'cnapp-services': {
    ...
    icon: 'bi-cloud',
    tagline: 'Security Across Your Organization',
    ...
    heroSplit: {
      ...
      titleHighlight: 'Proactive',
      subtitle: 'Our CNAPP expertise delivers seamless security integration, empowering you with streamlined protection and reduced risks. Gain confidence with proactive threat management, unified governance and the ability to stay ahead of threats while ensuring smooth application lifecycle management.',
      cards: [
        { stat: '43%', description: 'of organizations identified misconfigurations of permissions as their top concern in multi-cloud environments', source: 'CSA: Cloud Native Applications Protection Platform Report' },
        { stat: '85%', description: 'of enterprises struggle to prioritize cloud security events due to the overwhelming volume of alerts', source: 'Sysdig: 2025 Cloud-Native Security and Usage Report' },
        { stat: '45%', description: 'Faster mean time to detect (MTTD) by organizations leveraging CNAPPs' },
      ],
    },
    splits: [
      {
        ...
        sections: [
          {
            paragraph: 'Put your trust in a team of cloud security experts to guide you through a structured CNAPP implementation, customized to your organization\'s unique needs:',
            items: [
              ...
              'Identity and Access Management: Robust controls for identity verification, access permissions and user management to reduce unauthorized access risks',
          ...
          {
            paragraph: 'Our experts work closely with your security, development and operations teams to build a holistic CNAPP strategy, ensuring every layer of your cloud application is protected.',
          },
        ],
        image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/Large_triangle_icon_Cloud_right.png',
      },
      {
        ...
        imageLeft: true,
        paragraphs: [
          'Our custom services bring comprehensive protection to your cloud-native application. Whether you need help identifying the right CNAPP solution, implementing and customizing it or optimizing and maintaining it, we provide comprehensive, adaptable support. With our expertise, you gain a partner committed to securing your operations, simplifying complexity and ensuring peace of mind in an evolving threat landscape. What you can expect:',
        ],
        sectionsAllHidden: true,
        sections: [
          {
            items: [
              ...
              'Optimized Cloud Security Operations: Integrate and automate security workflows to enhance operational efficiency across your cloud environments',
    ...
    certGroups: [
      {
        ...
        certs: [
          ...
          { name: 'Azure Security Engineer', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2020/09/gps-cert-azure-security-engineer.png' },
          { name: 'AWS Solutions Architect Associate', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/image8965422010918071331-e1739297497214.webp' },
          { name: 'Tenable Harmonia', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/Tenable_Certifcation_Logos_TG-e1739297572272.webp' },
          { name: 'OSCP', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/1_48GeThQ3w_rWGAYSwbeBpw-e1739297629637.png' },
          { name: 'GPEN', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/01/cert_gpen.png' },
          { name: 'Azure Fundamentals', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/image-e1739297731455.png' },
          { name: 'AWS Solutions Architect Professional', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/AWS-Certified-Solutions-Architect-Professional_badge.69d82ff1b2861e1089539ebba906c70b011b928a-1-e1739297802797.png' },
          { name: 'Tenable TCSE-VM', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/images-e1739298022279.png' },
          { name: 'CND', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/EC-Council-CND-certwizard-e1739298416221.png' },
          { name: 'Terraform Associate', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/TerraFormAssociateCert-e1739298498495.png' },
          { name: 'Microsoft Fundamentals', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/05/unnamed_122-e1749838170254.png' },
          { name: 'AWS DevOps Engineer', image: 'https://www.guidepointsecurity.com/wp-content/uploads/2025/02/AWS-Certified-DevOps-Engineer-Professional_badge.7492bf660b5351e51f3f8015e4818924294a7e8c-e1739298625125.png' },
        ],
      },
    ],
    hideOutcomes: true,
...
// Slugs that are top-level category pages (route: /:slug)
const CATEGORY_SLUGS = new Set([
  'application-security', 'cloud-security', 'data-security', 'email-security',
  'endpoint-security', 'grc', 'iam', 'incident-response', 'managed-security',
  'network-security', 'security-awareness', 'soc', 'staff-augmentation',
...
export const servicesList = Object.entries(services)
  ...
  .map(([slug, s]) => ({
    icon: s.icon,
    title: s.title,
    path: CATEGORY_SLUGS.has(slug) ? `/${slug}` : `/services/${slug}`,
